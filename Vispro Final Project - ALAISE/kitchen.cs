...
namespace Vispro_Final_Project___ALAISE
{
    public partial class kitchen : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                koneksi.Open();
                query = "SELECT * FROM tbl_item_kitchen";
                perintah = new MySqlCommand(query, koneksi);
                adapter = new MySqlDataAdapter(perintah);
                ds.Clear();
                adapter.Fill(ds);
        ...
        private void lblsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                query = @"SELECT * FROM tbl_item_kitchen 
                  WHERE id_item_kitchen LIKE @searchValue 
        ...
        {
            kitchenadd kitchenAdd = new kitchenadd();
            kitchenAdd.Show();
            this.Close();
        }
        ...
        {
            updatekitchen updateKitchen = new updatekitchen();
            updateKitchen.Show();
            this.Close();
        }
